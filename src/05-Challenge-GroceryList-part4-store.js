...
var GroceryStore = (function (_EventEmitter) {
  _inherits(GroceryStore, _EventEmitter);

  function GroceryStore() {
    _classCallCheck(this, GroceryStore);

    _get(Object.getPrototypeOf(GroceryStore.prototype), "constructor", this).call(this);
    this.groceryItems = [{
      name: "Apples",
      completed: false
    }];
  ...
  _createClass(GroceryStore, [{
    ...
    key: "addGroceryItem",
    value: function addGroceryItem(item) {
