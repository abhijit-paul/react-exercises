...
var GroceryList = (function (_React$Component) {
  ...
  _createClass(GroceryList, [{
    ...
    value: function render() {
      ...
      newProductInput = React.createElement("input", { className: "new-item", value: this.state.newGroceryName, onKeyPress: this.handleKeyPress, type: "text", onChange: this.inputChanged });
